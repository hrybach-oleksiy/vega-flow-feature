import{La as P,fa as q,ga as g,ja as A}from"./chunk-UICEWDWD.js";import{j as Q,l as E,n as N,s as O}from"./chunk-OERL6A4R.js";import{$a as r,Bb as l,Cb as D,Db as F,Gb as f,Ia as o,Ib as m,Jb as y,Ob as j,Pb as S,R as v,S as h,Va as b,Wa as C,X as T,Za as $,_b as z,fa as p,gb as i,jb as k,kb as I,qb as u,rb as d,sb as x,tb as M,ub as w,vc as B}from"./chunk-JT2GHYKL.js";var V=["icon"],H=["*"];function G(e,c){if(e&1&&x(0,"span",4),e&2){let t=l(2);i("ngClass",t.icon)}}function J(e,c){if(e&1&&(M(0),r(1,G,1,1,"span",3),w()),e&2){let t=l();o(),i("ngIf",t.icon)}}function K(e,c){}function L(e,c){e&1&&r(0,K,0,0,"ng-template")}function U(e,c){if(e&1&&(u(0,"span",5),r(1,L,1,0,null,6),d()),e&2){let t=l();o(),i("ngTemplateOutlet",t.iconTemplate||t._iconTemplate)}}var W=({dt:e})=>`
.p-tag {
    display: inline-flex;
    align-items: center;
