import{Ca as A,Fa as P,j as Q,l as E,n as N,s as O,ya as q,za as g}from"./chunk-5WR6JU6M.js";import{Bb as m,Cb as y,Da as o,Gb as j,Hb as S,P as v,Pa as b,Q as h,Qa as C,Qb as z,Ta as $,V as T,Va as r,ab as i,da as p,db as k,eb as I,jb as u,kb as d,lb as x,lc as B,mb as M,nb as w,ub as l,vb as D,wb as F,zb as f}from"./chunk-XA2HF2BD.js";var V=["icon"],H=["*"];function G(e,c){if(e&1&&x(0,"span",4),e&2){let t=l(2);i("ngClass",t.icon)}}function J(e,c){if(e&1&&(M(0),r(1,G,1,1,"span",3),w()),e&2){let t=l();o(),i("ngIf",t.icon)}}function K(e,c){}function L(e,c){e&1&&r(0,K,0,0,"ng-template")}function U(e,c){if(e&1&&(u(0,"span",5),r(1,L,1,0,null,6),d()),e&2){let t=l();o(),i("ngTemplateOutlet",t.iconTemplate||t._iconTemplate)}}var W=({dt:e})=>`
.p-tag {
    display: inline-flex;
    align-items: center;
