import{c as tt}from"./chunk-XFJTPUOD.js";import{c as Z,d as v,f as S,g as C,h as x}from"./chunk-F2X3VGZZ.js";import{c as _}from"./chunk-HLDOTEFS.js";import{Ca as X,Fa as Y,G as H,Ra as et,j as $,l as q,m as z,n as G,s as W,v as T,ya as J,za as K}from"./chunk-5WR6JU6M.js";import{$a as P,Bb as y,Cb as g,Da as u,Fb as A,P as w,Pa as L,Qb as B,Rb as b,Sb as Q,Ta as k,Tb as j,V as I,Va as a,aa as p,ab as i,ba as m,cc as U,da as h,eb as O,jb as D,kb as E,lb as d,mb as F,mc as R,nb as V,pb as M,tb as N,ub as r,zb as f}from"./chunk-XA2HF2BD.js";var ot=["icon"],it=(e,l)=>({showTransitionParams:e,hideTransitionParams:l}),rt=e=>({value:"open",params:e}),lt=()=>({styleClass:"p-scrolltop-icon"}),st=()=>({"font-size":"1rem",scale:"1.5"});function at(e,l){if(e&1&&d(0,"span",7),e&2){let t=r(4);O(t._icon),i("ngClass","p-scrolltop-icon")}}function ct(e,l){e&1&&d(0,"ChevronUpIcon",8),e&2&&i("styleClass","p-scrolltop-icon")("ngStyle",b(2,st))}function pt(e,l){if(e&1&&(F(0),a(1,at,1,3,"span",5)(2,ct,1,3,"ChevronUpIcon",6),V()),e&2){let t=r(3);u(),i("ngIf",t._icon),u(),i("ngIf",!t._icon)}}function mt(e,l){}function ut(e,l){if(e&1&&a(0,mt,0,0,"ng-template",9),e&2){r(2);let t=A(2);i("ngIf",!t)}}function _t(e,l){if(e&1&&a(0,pt,3,2,"ng-container",3)(1,ut,1,1,null,4),e&2){let t=r(2);i("ngIf",!t.iconTemplate&&!t._iconTemplate),u(),i("ngTemplateOutlet",t.iconTemplate||t._iconTemplate)("ngTemplateOutletContext",b(3,lt))}}function ht(e,l){if(e&1){let t=M();D(0,"p-button",2),N("@animation.start",function(n){p(t);let s=r();return m(s.onEnter(n))})("@animation.done",function(n){p(t);let s=r();return m(s.onLeave(n))})("click",function(){p(t);let n=r();return m(n.onClick())}),a(1,_t,2,4,"ng-template",null,0,U),E()}if(e&2){let t=r();i("@animation",Q(8,rt,j(5,it,t.showTransitionOptions,t.hideTransitionOptions)))("styleClass",t.getStyleClass())("ngStyle",t.style)("buttonProps",t.buttonProps),P("aria-label",t.buttonAriaLabel)}}var dt=({dt:e})=>`
