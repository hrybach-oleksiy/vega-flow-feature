...
`,Jr={root:({props:e,instance:n})=>["p-badge p-component",{"p-badge-circle":E(e.value)&&String(e.value).length===1,"p-badge-dot":F(e.value)&&!n.$slots.default,"p-badge-sm":e.size==="small","p-badge-lg":e.size==="large","p-badge-xl":e.size==="xlarge","p-badge-info":e.severity==="info","p-badge-success":e.severity==="success","p-badge-warn":e.severity==="warn","p-badge-danger":e.severity==="danger","p-badge-secondary":e.severity==="secondary","p-badge-contrast":e.severity==="contrast"}]},ro=(()=>{class e extends k{name="badge";theme=Xr;classes=Jr;static \u0275fac=(()=>{let t;return function(o){return(t||(t=_(e)))(o||e)}})();static \u0275prov=A({token:e,factory:e.\u0275fac})}return e})();var xi=(()=>{class e extends j{styleClass=ct();style=ct();badgeSize=ct();size=ct();severity=ct();value=ct();badgeDisabled=ct(!1,{transform:D});_componentStyle=g(ro);containerClass=J(()=>{let t="p-badge p-component";return E(this.value())&&String(this.value()).length===1&&(t+=" p-badge-circle"),this.badgeSize()==="large"?t+=" p-badge-lg":this.badgeSize()==="xlarge"?t+=" p-badge-xl":this.badgeSize()==="small"&&(t+=" p-badge-sm"),F(this.value())&&(t+=" p-badge-dot"),this.styleClass()&&(t+=` ${this.styleClass()}`),this.severity()&&(t+=` p-badge-${this.severity()}`),t});static \u0275fac=(()=>{let t;return function(o){return(t||(t=_(e)))(o||e)}})();static \u0275cmp=Z({type:e,selectors:[["p-badge"]],hostVars:6,hostBindings:function(i,o){i&2&&(Ui(o.style()),Ft(o.containerClass()),Wi("display",o.badgeDisabled()?"none":null))},inputs:{styleClass:[1,"styleClass"],style:[1,"style"],badgeSize:[1,"badgeSize"],size:[1,"size"],severity:[1,"severity"],value:[1,"value"],badgeDisabled:[1,"badgeDisabled"]},features:[S([ro]),y],decls:1,vars:1,template:function(i,o){i&1&&xe(0),i&2&&Oe(o.value())},dependencies:[At,mt],encapsulation:2,changeDetection:0})}return e})(),so=(()=>{class e{static \u0275fac=function(i){return new(i||e)};static \u0275mod=L({type:e});static \u0275inj=$({imports:[xi,mt,mt]})}return e})();var es=["*"],is=`
.p-icon {
    display: inline-block;
    vertical-align: baseline;
}
